...
void M_SinglePlayer_Draw (void)
{
	...
	if (kurok)
	{
		...
		if (m_singleplayer_cursor == 3)
		    m = Draw_CachePic ("gfx/menu/maps.lmp");
		else
		    m = Draw_CachePic ("gfx/menu/maps.lmp");
            M_DrawPic((320-s->width)/2, 208, m);
	...
	else
	{
	  //  M_DrawTransPic (16, 4, Draw_CachePic ("gfx/qplaque.lmp") );
        ...
        M_DrawTransPic (70, 95, Draw_CachePic ("gfx/maps.lmp") );
...
void M_Maps_Draw (void)
{
	...
	M_DrawTransPic (150, 16, Draw_CachePic ("gfx/maps.lmp") );
...
char *bindnames[][2] =
{
{"impulse 96", 		"Blue Portal"},
{"impulse 95", 		"Yelow Portal"},
{"impulse 94", 		"Portal Grip"},
{"impulse 98", 		"Reset Portals"},
{"impulse 99", 		"Portal Gun"},
{"+jump", 			"Jump / Swim Up"},
...
void M_Help_Draw (void)
{
	    M_Print(0, 20,  "Quartal 2013:");

		M_Print(-80, 40, "Thanks to:");
		M_PrintWhite(-80, 50, "siska.robert");
		M_PrintWhite(-80, 60, "dimaflash");
		M_PrintWhite(-80, 70, "Zeting");
		M_PrintWhite(-80, 80, "SeniorMeatbox");
		M_PrintWhite(-80, 90, "Ghost_Fang");
		M_PrintWhite(-80, 100, "Weegee9000");
		M_PrintWhite(-80, 110, "numbersix");
		M_PrintWhite(-80, 120, "Uncle Mike");
		M_PrintWhite(-80, 130, "Crow_Bar");
		M_PrintWhite(-80, 140, "ThatPolyDude");
		M_PrintWhite(-80, 150, "MDave(Kurok Engine)");
		M_PrintWhite(-80, 160, "Valve(Original Portal),and there is my HL3,GAABE?");
		M_PrintWhite(-80, 170, "ID Software(Quake Engine)");
		M_PrintWhite(-80, 180, "Inside3D(Tutorials,help)");
		M_Print(-80, 190, "(c)st1x51");
		M_PrintWhite(100, 200, "Knowledge is power");
		M_Print(250, 200, "(c)Inside3D");
}
